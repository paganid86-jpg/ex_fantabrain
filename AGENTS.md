...
| AI chatbot Gold | Anthropic `Codex-sonnet-4-6` via backend `/api/ai/chat` |
| Dati calcio | football-data.org v4 (Serie A 2025/2026, piano Free) |
| Deploy | Render.com (Node web service) |

## Regole critiche

1. **Branch**: sempre `Codex/descrizione-SESSIONID` — mai pushare su `main` direttamente
